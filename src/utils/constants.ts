...
export function getDuration(challengeType: ChallengeType): BigInt {
  ...
  if (challengeType == ChallengeType.OneWeek) return BigInt.fromI32(30 * 60);
  if (challengeType == ChallengeType.OneMonth) return BigInt.fromI32(1 * 60 * 60);
  if (challengeType == ChallengeType.ThreeMonths) return BigInt.fromI32(2 * 60 * 60);
...
// BASE Mainnet
export const STELE_ADDRESS = '0x9FCe4D3110ce3eE074b4B8c15374EAb3FE1Faa0d'
